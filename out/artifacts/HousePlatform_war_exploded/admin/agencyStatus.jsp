            ...
            <div class="ibox float-e-margins">
                <div class="table table-responsive container">
                    <table class="table table-striped" id="myTable">
                        <thead>
                        <th colspan="7">
                            <button type="button" class="btn btn-primary" onclick="changeStatus('change');">激活</button>
                        ...
                        <tr ng-repeat="a in agency">
                                ...
                                <td>
                                    ...
                                    <p style="color:red;" ng-show="{{a.status == '0' }}">不可用</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<form action="" method="post" id="formid">
    ...
    <input type="hidden" name="agency.status" id="status" value="0"/>
</form>
...
<script src="<%=path%>/public/js/content.min.js"></script>
...
<script>
    ...
    function agencyDetail() {
        ...
        if (chk_value.length == 1) {
            ...
            $('#detform').prop("action", "<%=path %>/agency/agencyDetail").submit();
        } else {
            layer.msg("请选择一行！");
        }
