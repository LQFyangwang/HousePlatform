                ...
                <div class="ibox float-e-margins">
                    <div class=" table table-responsive container">
                        <table class="table table-striped">
                            ...
                            <th colspan="1" id="Yes" class="hidden">
        ...
        app.controller('myCtrl', function($scope,$http,$timeout,$filter) {
            ...
            $scope.changeYes =function () {
                if ($("input[name='cusCheckId']:checkbox:checked").length ==1) {
                    ...
                    parent.$('#customerName',parent.document).val($scope.customers[$scope.count].name);
                    parent.$('#customerId',parent.document).val($scope.customers[$scope.count].id);
