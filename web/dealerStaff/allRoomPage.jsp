                ...
                <div class="ibox float-e-margins">
                    <div class=" table table-responsive container">
                        <table class="table table-striped ">
                            ...
                            <tr>
                                <th colspan="3">
                                    <button type="button" id="onclickbtn" class="btn btn-primary"
                                            ng-click="onclickbtn();" >修改状态
                                    </button>
                                    <button type="button" id="changeNo" class="btn btn-primary"
                                            ng-click="changeNo();" >查看业主信息
                                    </button>
                                    <button type="button" id="Yes" class="btn btn-primary hidden"
                                            ng-click="changeYes();" >确定
                                    </button>
    ...
    (function ($) {
        ...
        app.controller('myCtrl', function ($scope, $http, $timeout,$filter) {
            ...
            $http({
                ...
                data:{"buildingsId":"${sessionScope.employee.buildingsPrice.id}"}
            ...
            function extracted(x,building) {
                ...
                var data1 = {"pageNo": x, "sale_status": $("#sale_status").val(),"buildings_id":"${sessionScope.employee.buildingsPrice.id}","buildingId":building};
                $http({
                    method: 'POST',
                    url: urls,
                    data: data1
            ...
            $scope.changeYes =function () {
                if ($("input[name='employeeId']:checkbox:checked").length ==1) {
                    ...
                    if($scope.RoomPager[$scope.count].count>0){
                        layer.msg("此房间已有业主无法添加！");
                    }else {
                        parent.$('#roomName',parent.document).val($scope.RoomPager[$scope.count].name);
                        parent.$('#roomId',parent.document).val($scope.RoomPager[$scope.count].id);
